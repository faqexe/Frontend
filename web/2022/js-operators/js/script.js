...
// Вариант №1
console.log('35' + - "22");
// Вернет 13 - не правильно, вернте строку 35-22
...
// Вариант №3
// console.log('558' > 22++);
// Вернет true - ошибка, недопустимый второй операнд

// Вариант №4
let usersCounter = 0;
let newUsers = usersCounter++;
console.log(newUsers);
// Вернет 1 - не правильно, вернет 0, так как используется постфиксная форма

// Вариант №5
console.log(!false && 11 || 18 && !'');
// Вернет 18 - не правильно, вернет 11 по итоговому выражению 11 || true

// Вариант №6
let name = 0;
console.log(name ?? "Без имени");
// Вернет 0, так как оператор возвращает первый аргумент

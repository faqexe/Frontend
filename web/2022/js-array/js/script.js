...
4, так как новая переменная является ключом к основному массиву и так же через нее можно добавлять значения массива
*/
// Задача №2.
/*
...
9, так как не указано начальное значение
*/

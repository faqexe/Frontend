...
запись не верна, нет запятых, после свойств
...
Вывод в консоль - Значение свойства
...
Запись неверна, так как при выводе нет квадратных скобок. Верный вывод - console.log(userInfo["likes js"]);
*/
// Задача №8
/*

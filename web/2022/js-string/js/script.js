...
console.log(text);
Запись не верна, так как в переменной text строка должна заключаться в обратные кавычки
let fls = "фрилансер";
let text = `Привет! Я ${fls}`;
console.log(text);
...
// Ожидаем 579
console.log(text);
Не верно, так как сложение со строкой выведет строку - 123456
